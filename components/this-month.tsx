        ...
        <section className="py-16 relative">
            <div className="max-w-3xl mx-auto px-4">
                <Reveal>
                    <Link
                        href="/events"
                        className="flex flex-col sm:flex-row items-center gap-6 bg-neutral-900/50 border border-neutral-800 hover:border-orange-500/40 rounded-2xl p-6 transition-colors group"
                    >
                        <div className="w-14 h-14 rounded-xl bg-orange-500/10 flex items-center justify-center flex-shrink-0">
                            <Calendar className="text-orange-500" size={26} />
                        </div>
                        ...
                        <ArrowRight className="text-neutral-500 group-hover:text-orange-500 group-hover:translate-x-1 transition-all flex-shrink-0" size={20} />
                    </Link>
                </Reveal>
            </div>
        </section>
