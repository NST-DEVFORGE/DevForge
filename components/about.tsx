                    ...
                    {features.map((feature, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="glass-panel p-6 hover:border-cyan-400/30 transition-all group"
                            >
                                <div className="bg-cyan-400/10 w-12 h-12 rounded-lg flex items-center justify-center mb-4 group-hover:bg-cyan-400/20 transition-colors">
